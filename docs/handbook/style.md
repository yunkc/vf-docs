...
| dragOption | BaseDrag |  | 拖动设置，具体可参考拖动章节,[参考示例](https://vipkid-edu.github.io/vf-gui-docs/play/#example/TestDrag) |
...
| cursor |  string | | 设置鼠标样式，[参考示例](https://vipkid-edu.github.io/vf-gui-docs/play/#example/TestMouseCursor) |
...
> display = 'grid' 模式下，子节点会忽略left,top,right，bottom,width,height等 ,[参考示例](https://vipkid-edu.github.io/vf-gui-docs/play/#example/TestGridLayout)
